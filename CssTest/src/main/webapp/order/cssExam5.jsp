...
#parent #child {background: orange; color: green;}

#grandchild {background: yellow; color: red;}

.first #grandchild {background: green; color: black;}

#parent-child {	background: blue; color: purple;}

#parent .second {background: purple; color: orange;}
</style>
</head>
<body>
